...
public class PriorIndex extends Distribution {
    ...
    final public Input<Integer> indexInput = new Input<>("index", "index of paramter to put prior on, starts counting at 0", Validate.REQUIRED);
    ...
    public double calculateLogP() {
        ...
        if (x instanceof RealParameter || x instanceof IntegerParameter) {
            ...
            double value = x.getArrayValue(indexInput.get());
            if (value < l || value > h) {
        ...
        logP = dist.logDensity(x.getArrayValue(indexInput.get()));
